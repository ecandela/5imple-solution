...
import com.mindstorm.data.repository.base.BaseRepositoryFactoryBean;
...
@Configuration
@ComponentScan({"com.mindstorm.data","com.mindstorm.service"}) // search the com.company package for @Component classes
@PropertySource("classpath:db.properties")
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = "com.mindstorm.data.repository", repositoryFactoryBeanClass = BaseRepositoryFactoryBean.class)
...
public class SpringDataConfig {
    ...
    @Bean public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.mindstorm.data.entity");
